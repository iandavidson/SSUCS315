...
enum { LPAREN = '(', LBRACK = '[', LCURLY = '{', RPAREN = ')', RBRACK = ']', RCURLY = '}' };// brackets and curly must also be interpreted by lParen and Rparen respectivly
...
Token Lex::getToken()
{
    ...
    if( inputToTokenize[whereToStart] == LPAREN || inputToTokenize[whereToStart] == LBRACK || inputToTokenize[whereToStart] == LCURLY || inputToTokenize[whereToStart] == RPAREN || inputToTokenize[whereToStart] == RBRACK || inputToTokenize[whereToStart] == RCURLY ) {
